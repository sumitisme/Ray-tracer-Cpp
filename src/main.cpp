...
int main(int argc, char* argv[]) {
    ...
    auto material_right = make_shared<metal>(color(0.8, 0.1, 0.2));
    auto material_top = make_shared<metal>(color(0.8, 0.1, 0.2));
    ...
    world.add(make_shared<sphere>(point3(0.8, 0.0, -1.1), 0.5, material_left));
    world.add(make_shared<sphere>(point3(0.2, 0.8, -1.1), 0.5, material_left));
